...
@Composable
fun ListItemsView(modifier: Modifier = Modifier, listId: String, navController: NavController = rememberNavController()) {
    ...
    Box(modifier = modifier.fillMaxSize(), contentAlignment = Alignment.BottomEnd) {
        ...
        Button(
            ...
            onClick = { navController.navigate(Screen.AddItem.route.replace("{listId}", listId)) }
        ) {
            Image(
